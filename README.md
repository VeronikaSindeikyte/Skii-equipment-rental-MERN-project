...
- **Reservation Modification**: Users can modify reservation dates or delete reservations.
...
![image](https://github.com/user-attachments/assets/26f985e2-7405-4cf0-808d-23d4f7cb08d1)
...
| PATCH  | `/api/user/:id`      | Change user role (Admin only)   |
...
| Method | Endpoint                                  | Description                                   |
|--------|-------------------------------------------|-----------------------------------------------|
| POST   | `/api/reservations/reserve`               | Create a reservation (User and Admin)         |
| GET    | `/api/reservations/user`                  | Get all reservations (User)                   |
| GET    | `/api/reservations/user/:reservationId`   | Get one reservation for a user (User)         |
| PATCH  | `/api/reservations/update/:reservationId` | Change reservation date (User)                |
| DELETE | `/api/reservations/user/delete`           | Delete reservation (User)                     |
